...
;Фнкция определения соседей
to-report in-neighborhood? [ hood ]
  report ( member? end1 hood and member? end2 hood )
end

;Функция нахождения коэффициента кластеризации
...
;Функция нахождения средней длины пути 
...
;Функция создания связей между агентами
...
;Функция ограничения числа связей
to vertex-degree
